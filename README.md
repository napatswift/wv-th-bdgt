...
3.  **Google Cloud Authentication (for Colab/GSpread):**
    ...
    For local development or CI/CD, you might need to set up a Google Cloud Project, enable the Google Drive and Google Sheets APIs, and create a service account with appropriate permissions. The `gspread` library documentation provides detailed instructions for this.
